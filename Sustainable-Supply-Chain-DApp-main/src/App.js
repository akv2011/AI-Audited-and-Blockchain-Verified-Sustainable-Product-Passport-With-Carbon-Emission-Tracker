...
import LCIForm from './components/pages/LCIForm';
...
import LCIReport from './components/pages/LCIReport';
...
function App() {
    return (
        ...
        <Router>
            ...
            <Route path="/forms/lci" element= {<LCIForm/>}/>
            ...
            <Route path="/reports/lci" element= {<LCIReport/>}/>
